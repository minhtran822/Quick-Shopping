        ...
        switch($_GET["action"]) {
            case "add":
                if(!empty($_POST["quantity"])) {
                    $resultSet = mysqli_query($conn,"SELECT * FROM products WHERE code='" . $_GET["code"] . "';");
                    while($rowItem=mysqli_fetch_assoc($resultSet)) {
                        $productByCode[] = $rowItem;
                    }
...
?>
        ...
        ?>
            ...
            <td class="dogId"><?php echo $item["code"]; ?></td>
